...
install_pubkey_paradigm4:
  file.managed:
    ...
    - source: {{ salt['pillar.get']('paradigm4:key', locals.key) }}
    - source_hash: {{ salt['pillar.get']('paradigm4:pubkey_hash', locals.key_hash) }}

paradigm4_repo:
  pkg.installed:
    - sources:
      - paradigm4-repo: {{ salt['pillar.get']('paradigm4:rpm', locals.rpm) }}
    - require:
